...
public:
    CMainParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("dns1.btcd.io", "seed1.dns.btcd.io"));
        vSeeds.push_back(CDNSSeedData("dns2.btcd.io", "seed2.dns.btcd.io"));
        vSeeds.push_back(CDNSSeedData("dns3.btcd.io", "seed3.dns.btcd.io"));
        vSeeds.push_back(CDNSSeedData("dns4.btcd.io", "seed4.dns.btcd.io"));
        vSeeds.push_back(CDNSSeedData("dns5.btcd.io", "seed5.dns.btcd.io"));
        vSeeds.push_back(CDNSSeedData("dns6.btcd.io", "seed6.dns.btcd.io"));
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000001dce6b2014d6b52aa5");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000000013bf4ce320a76c251b0bc337112eeaa9912f0c9a7b6835b9c7b803"); //991733
