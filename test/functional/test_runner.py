...
def run_tests(test_list, src_dir, build_dir, exeext, tmpdir, jobs=1, enable_coverage=False, args=[], combined_logs_len=0):
    ...
    try:
        if subprocess.check_output(["pidof", "bitcoindiamondd"]) is not None:
    ...
    if "BITCOIND" not in os.environ:
        os.environ["BITCOIND"] = build_dir + '/src/bitcoindiamondd' + exeext
        os.environ["BITCOINCLI"] = build_dir + '/src/bitcoindiamond-cli' + exeext
